...
interface SuperSetAddRowButtonProps {
    supersetId: SuperSet["id"];
    layoutId: Layout["id"];
};

const SuperSetAddRowButton: React.FC<SuperSetAddRowButtonProps> = ({ supersetId, layoutId }) => {
...
export default SuperSetAddRowButton;