...
import SuperRestSettings from "../stopwatch/SuperRestSettings";
import SuperSetModeButton from "./SuperSetModeButton";
import SuperSetSettings from "./SuperSetSettings";
import { useRoutine } from "@/components/context/RoutineZustand";

interface SuperSetTableHeaderProps {
    supersetId: SuperSet["id"];
}

const SuperSetTableHeader: React.FC<SuperSetTableHeaderProps> = ({ supersetId }) => {
    ...
    return (
        <Container style={{ marginBottom: 16 }} width={"90%"} direction="row" >
            ...
            >
                <SuperSetSettings supersetId={supersetId} onClose={popBubble} />
            </IBubble>
            ...
            <View style={{ flex: 3, alignItems: "flex-start" }} >
                ...
                <SuperRestSettings supersetId={supersetId} />
            </View>
            <View style={{ flex: 2, alignItems: "flex-end" }} >
                ...
                <SuperSetModeButton supersetId={supersetId} />
            </View>
        </Container>
    );
}
...
export default SuperSetTableHeader;